...
// Источники автозагрузки Windows.
...
func AutostartSourceOrder() []AutostartSource {
	return []AutostartSource{
		AutostartRunHKCU, AutostartRunHKLM, AutostartRunHKLM32,
		AutostartStartupFolderUser, AutostartStartupFolderCommon, AutostartScheduledTask,
	}
}
...
func AutostartSourceLabel(s AutostartSource) string {
	switch s {
	case AutostartRunHKCU:
		return "Реестр — Run (текущий пользователь)"
	case AutostartRunHKLM:
		return "Реестр — Run (все пользователи)"
	case AutostartRunHKLM32:
		return "Реестр — Run (32-бит, WOW6432Node)"
	case AutostartStartupFolderUser:
		return "Папка автозагрузки (пользователь)"
	case AutostartStartupFolderCommon:
		return "Папка автозагрузки (все пользователи)"
	case AutostartScheduledTask:
		return "Задания планировщика (при входе в систему)"
	}
	return string(s)
}
